      ...
      <div>
        ...
        <div className="mt-6 pl-4">
          ...
          <div className="mt-2  flex flex-col gap-4">
              {responses
  ?.filter(item => item.sender === "user") // show only user messages
  .map((item, i) => (
    <div
      key={i}
      className="bg-[#242424] h-10 p-2 rounded-lg flex justify-between group"
    >
      <h2 className="text-white text-sm truncate">{item.text}</h2>
      <span>
        <ClearIcon
